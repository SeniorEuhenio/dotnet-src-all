...
{                                   
    ...
    /* 0x3c */ MilCmdPartitionNotifyPolicyChangeForNonInteractiveMode = 0x3c,
    ...
    /* 0x3d */ MilDrawLine                                   = 0x3d,
    /* 0x3e */ MilDrawLineAnimate                            = 0x3e,
    /* 0x3f */ MilDrawRectangle                              = 0x3f,
    /* 0x40 */ MilDrawRectangleAnimate                       = 0x40,
    /* 0x41 */ MilDrawRoundedRectangle                       = 0x41,
    /* 0x42 */ MilDrawRoundedRectangleAnimate                = 0x42,
    /* 0x43 */ MilDrawEllipse                                = 0x43,
    /* 0x44 */ MilDrawEllipseAnimate                         = 0x44,
    /* 0x45 */ MilDrawGeometry                               = 0x45,
    /* 0x46 */ MilDrawImage                                  = 0x46,
    /* 0x47 */ MilDrawImageAnimate                           = 0x47,
    /* 0x48 */ MilDrawGlyphRun                               = 0x48,
    /* 0x49 */ MilDrawDrawing                                = 0x49,
    /* 0x4a */ MilDrawVideo                                  = 0x4a,
    /* 0x4b */ MilDrawVideoAnimate                           = 0x4b,
    /* 0x4c */ MilPushClip                                   = 0x4c,
    /* 0x4d */ MilPushOpacityMask                            = 0x4d,
    /* 0x4e */ MilPushOpacity                                = 0x4e,
    /* 0x4f */ MilPushOpacityAnimate                         = 0x4f,
    /* 0x50 */ MilPushTransform                              = 0x50,
    /* 0x51 */ MilPushGuidelineSet                           = 0x51,
    /* 0x52 */ MilPushGuidelineY1                            = 0x52,
    /* 0x53 */ MilPushGuidelineY2                            = 0x53,
    /* 0x54 */ MilPushEffect                                 = 0x54,
    /* 0x55 */ MilPop                                        = 0x55,
    ...
    /* 0x56 */ MilCmdAxisAngleRotation3D                     = 0x56,
    /* 0x57 */ MilCmdQuaternionRotation3D                    = 0x57,
    /* 0x58 */ MilCmdPerspectiveCamera                       = 0x58,
    /* 0x59 */ MilCmdOrthographicCamera                      = 0x59,
    /* 0x5a */ MilCmdMatrixCamera                            = 0x5a,
    /* 0x5b */ MilCmdModel3DGroup                            = 0x5b,
    /* 0x5c */ MilCmdAmbientLight                            = 0x5c,
    /* 0x5d */ MilCmdDirectionalLight                        = 0x5d,
    /* 0x5e */ MilCmdPointLight                              = 0x5e,
    /* 0x5f */ MilCmdSpotLight                               = 0x5f,
    /* 0x60 */ MilCmdGeometryModel3D                         = 0x60,
    /* 0x61 */ MilCmdMeshGeometry3D                          = 0x61,
    /* 0x62 */ MilCmdMaterialGroup                           = 0x62,
    /* 0x63 */ MilCmdDiffuseMaterial                         = 0x63,
    /* 0x64 */ MilCmdSpecularMaterial                        = 0x64,
    /* 0x65 */ MilCmdEmissiveMaterial                        = 0x65,
    /* 0x66 */ MilCmdTransform3DGroup                        = 0x66,
    /* 0x67 */ MilCmdTranslateTransform3D                    = 0x67,
    /* 0x68 */ MilCmdScaleTransform3D                        = 0x68,
    /* 0x69 */ MilCmdRotateTransform3D                       = 0x69,
    /* 0x6a */ MilCmdMatrixTransform3D                       = 0x6a,
    /* 0x6b */ MilCmdPixelShader                             = 0x6b,
    /* 0x6c */ MilCmdImplicitInputBrush                      = 0x6c,
    /* 0x6d */ MilCmdBlurEffect                              = 0x6d,
    /* 0x6e */ MilCmdDropShadowEffect                        = 0x6e,
    /* 0x6f */ MilCmdShaderEffect                            = 0x6f,
    /* 0x70 */ MilCmdDrawingImage                            = 0x70,
    /* 0x71 */ MilCmdTransformGroup                          = 0x71,
    /* 0x72 */ MilCmdTranslateTransform                      = 0x72,
    /* 0x73 */ MilCmdScaleTransform                          = 0x73,
    /* 0x74 */ MilCmdSkewTransform                           = 0x74,
    /* 0x75 */ MilCmdRotateTransform                         = 0x75,
    /* 0x76 */ MilCmdMatrixTransform                         = 0x76,
    /* 0x77 */ MilCmdLineGeometry                            = 0x77,
    /* 0x78 */ MilCmdRectangleGeometry                       = 0x78,
    /* 0x79 */ MilCmdEllipseGeometry                         = 0x79,
    /* 0x7a */ MilCmdGeometryGroup                           = 0x7a,
    /* 0x7b */ MilCmdCombinedGeometry                        = 0x7b,
    /* 0x7c */ MilCmdPathGeometry                            = 0x7c,
    /* 0x7d */ MilCmdSolidColorBrush                         = 0x7d,
    /* 0x7e */ MilCmdLinearGradientBrush                     = 0x7e,
    /* 0x7f */ MilCmdRadialGradientBrush                     = 0x7f,
    /* 0x80 */ MilCmdImageBrush                              = 0x80,
    /* 0x81 */ MilCmdDrawingBrush                            = 0x81,
    /* 0x82 */ MilCmdVisualBrush                             = 0x82,
    /* 0x83 */ MilCmdBitmapCacheBrush                        = 0x83,
    /* 0x84 */ MilCmdDashStyle                               = 0x84,
    /* 0x85 */ MilCmdPen                                     = 0x85,
    /* 0x86 */ MilCmdGeometryDrawing                         = 0x86,
    /* 0x87 */ MilCmdGlyphRunDrawing                         = 0x87,
    /* 0x88 */ MilCmdImageDrawing                            = 0x88,
    /* 0x89 */ MilCmdVideoDrawing                            = 0x89,
    /* 0x8a */ MilCmdDrawingGroup                            = 0x8a,
    /* 0x8b */ MilCmdGuidelineSet                            = 0x8b,
    /* 0x8c */ MilCmdBitmapCache                             = 0x8c,
    ...
    /* 0x8d */ MilCmdValidateStructureOrder                  = 0x8d
#endif
};
