            ...
            try {
                ...
                try {
                    ...
                    if( UseCompatibleTextRendering ){
                        ...
                        // CONSIDER: we are painting w/ GDI and GDI does not use Regions.
                        // Ideally we would have the LinkLabel use either Regions (for GDI+) or Rectangles (for GDI).
                        // But it is too late in the product cycle and I am afraid what would break.
